...
> 积分采取精算点记录，顺位码点： 20 点 10 点 -10 点 -20 点，码点在大将后半结束后进行计算。例：风越以170000分获得第一轮次级联赛的首位，则风越的当轮码点为37，最终获得积分3.7。神功则是50000分在第一轮吃四，则神功的当轮码点为-15，最终获得积分-1.5。

> 比赛规则与主联赛常规赛规则一致

> 升级队伍均将获得最终积分乘以五的现金奖励（可叠加成就系数）
...
- 获胜队伍为主联赛需要参加升降级附加赛的队伍，直接保级，附加赛名额顺延；
- 获胜队伍为主联赛直接降级队伍，将改为参加升降级附加赛，次级联赛附加赛名额减少一个；（即主联赛5个队伍，次级联赛3个队伍参加升降级附加赛）
- 获胜队伍为次级联赛直接升级队伍，奖励系数+5；
- 获胜队伍为次级联赛需要参加升降级附加赛的队伍，直接升级，主联赛附加赛名额增加一个，且附加赛将只决出3个升级（保级）名额；（即主联赛5个队伍，次级联赛3个队伍参加升降级附加赛）
