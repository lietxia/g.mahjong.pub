...
> 次级联赛将由32支队伍进行17轮的全随机抽签分组对决（每轮分组将于赛前在大凤林进行公示），最终排名前二的两所学校将获得直接升入主联赛的资格，而排名3-6位的学校则将于主联赛降级区的四支队伍进行升降级附加赛，决出下赛季的四个主联赛名额。

> 积分采取精算点记录，顺位码点： 20点 10 点 -10 点 -20 点，码点在大将后半结束后进行计算
